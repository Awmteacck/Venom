...
XeonBotInc.ev.on("connection.update",async  (s) => {
        ...
        if (connection == "open") {
	        ...
	        console.log(chalk.magenta(`\n${themeemoji} YT CHANNEL: Awmtea Polythene`))
            console.log(chalk.magenta(`${themeemoji} GITHUB: Awmteacck `))
            console.log(chalk.magenta(`${themeemoji} INSTAGRAM: @awmtea._.polythene `))
            console.log(chalk.magenta(`${themeemoji} WA NUMBER: ${$}`))
